...
typedef struct _meshtastic_Config_DeviceConfig {
 ...
 Defaults to 900 Seconds (15 minutes) */
    ...
    /* Number of days to keep node info in node db since last heard from */
    uint32_t node_db_expiration_days;
...
#define meshtastic_Config_DeviceConfig_node_db_expiration_days_tag 9
...
X(a, STATIC,   SINGULAR, FIXED32,  node_db_expiration_days,   9)
...
#define meshtastic_Config_DeviceConfig_size      33
